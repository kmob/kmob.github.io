...
var seq__587_591 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__588_592 = null;
var count__589_593 = (0);
var i__590_594 = (0);
while(true){
if((i__590_594 < count__589_593)){
var str_595 = cljs.core._nth.call(null,chunk__588_592,i__590_594);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_595})));
...
var temp__5735__auto___600 = cljs.core.seq.call(null,seq__587_591);
if(temp__5735__auto___600){
var seq__587_601__$1 = temp__5735__auto___600;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__587_601__$1)){
var c__4609__auto___602 = cljs.core.chunk_first.call(null,seq__587_601__$1);
var G__603 = cljs.core.chunk_rest.call(null,seq__587_601__$1);
var G__604 = c__4609__auto___602;
var G__605 = cljs.core.count.call(null,c__4609__auto___602);
var G__606 = (0);
seq__587_591 = G__603;
...
var str_607 = cljs.core.first.call(null,seq__587_601__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_607})));
...
var script__$1 = (function (){var G__616 = script;
goog.object.set(G__616,"type","text/javascript");

goog.object.set(G__616,"onload",onload);

goog.object.set(G__616,"onreadystatechange",onload);

return G__616;
})();
if((opt_sourceText == null)){
var G__617 = script__$1;
goog.object.set(G__617,"src",src);

return G__617;
} else {
var G__618 = script__$1;
goog.dom.setTextContent(G__618,opt_sourceText);
...
var path_619 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_619);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_619)].join(''));
} else {
var path_620 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_620);

goog.object.remove(goog.dependencies_.written,path_620);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_620)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__621 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__622 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__622);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__621);
}})()})));
}));
